...
var filtreLive = true;
var filtreMyProvence = true;
var filtreCode4Marseille = true;
var filtreBouche = true;
...
//Filtre C4M
$("#tagCode4Marseille").on('click', function () {
    if(filtreCode4Marseille)    {
        filtreCode4Marseille = false;
    }   else {
        filtreCode4Marseille = true;
    }
...
//Filre MyProvence
$("#tagMyProvence").on('click', function () {
    if(filtreMyProvence)    {
        filtreMyProvence = false;
    }   else {
        filtreMyProvence = true;
    }
    idInsta = [];
    map.removeLayer(photoLayer);
    photoLayer = L.photo.cluster({spiderfyDistanceMultiplier: 1.6}).on('click', function (evt) {
